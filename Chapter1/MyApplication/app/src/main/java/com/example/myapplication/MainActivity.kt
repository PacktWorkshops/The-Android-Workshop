    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enter_button.setOnClickListener(View.OnClickListener {
            ...
            if (firstName.trim().isNotBlank() && lastName.trim().isNotBlank()) {
                ...
                greeting_display.text = " ${getString(R.string.welcome_to_the_app)} ${nameToDisplay}!"
            }
            else {
                val toast = Toast.makeText(this, getString(R.string.please_enter_a_name), Toast.LENGTH_LONG)
